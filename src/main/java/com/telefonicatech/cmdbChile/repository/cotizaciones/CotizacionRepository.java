...
public interface CotizacionRepository extends JpaRepository<Cotizacion, UUID> {
        ...
        @Query(value = """
                        ...
                        WHERE idCotizacion = UUID_TO_BIN(:idCotizacion)
                        """, nativeQuery = true)
        void updateObservacion(@Param("idCotizacion") String idCotizacion,
        ...
        void insertarHistorial(
                        ...
                        @Param("idEstadoAnterior") Integer idEstadoAnterior,
                        @Param("idEstadoNuevo") Integer idEstadoNuevo,
