...
CREATE TABLE IF NOT EXISTS transicionestado (
    ...
    CONSTRAINT fk_transicionestado_origen FOREIGN KEY (idEstadoOrigen) REFERENCES estadocotizacion(idestadoCotizacion),
    CONSTRAINT fk_transicionestado_destino FOREIGN KEY (idEstadoDestino) REFERENCES estadocotizacion(idestadoCotizacion),
    CONSTRAINT uk_transicion UNIQUE (idEstadoOrigen, idEstadoDestino)
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'Define las transiciones de estado permitidas en el sistema';
...
CREATE TABLE IF NOT EXISTS transicionestadorol (
    ...
    CONSTRAINT fk_transicionestadorol_transicion FOREIGN KEY (idTransicion) REFERENCES transicionestado(idTransicion) ON DELETE CASCADE,
    CONSTRAINT fk_transicionestadorol_rol FOREIGN KEY (idRol) REFERENCES rol(idrol) ON DELETE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'Relaciona transiciones de estado con roles autorizados';
-- ============================================
...
VALUES (
        2,
        1,
        'Devolver a borrador para correcciones',
        TRUE
    );
-- ============================================
-- Desde APROBADA (3)
...
-- ============================================
INSERT INTO transicionestadorol (idTransicion, idRol)
VALUES (1, 1),
    (1, 2);
-- ============================================
